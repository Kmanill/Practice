...
const ds = new DataSource({
  ...
  username: process.env.POSTGRES_USER || process.env.DB_USER || 'nestuser',
  password: process.env.POSTGRES_PASSWORD || process.env.DB_PASSWORD || 'nestpass',
  database: process.env.POSTGRES_DB || process.env.DB_NAME || 'nestdb',
});
